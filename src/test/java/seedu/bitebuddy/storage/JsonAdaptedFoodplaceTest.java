...
public class JsonAdaptedFoodplaceTest {
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedFoodplace foodplace =
                new JsonAdaptedFoodplace(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CUISINE,
                        invalidTags, VALID_NOTE, VALID_RATING, VALID_WISHLIST);
    ...
    public void toModelType_nullNote_throwsIllegalValueException() {
        ...
        JsonAdaptedFoodplace foodplace =
                new JsonAdaptedFoodplace(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CUISINE,
                         VALID_TAGS, null, VALID_RATING, VALID_WISHLIST);
    ...
    public void toModelType_invalidNote_throwsIllegalValueException() {
        JsonAdaptedFoodplace foodplace =
                new JsonAdaptedFoodplace(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CUISINE,
                        VALID_TAGS, INVALID_NOTE, VALID_RATING, VALID_WISHLIST);
    ...
    public void toModelType_nullRating_throwsIllegalValueException() {
        JsonAdaptedFoodplace foodplace =
                new JsonAdaptedFoodplace(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CUISINE,
                        VALID_TAGS, VALID_NOTE, null, VALID_WISHLIST);
    ...
    public void toModelType_invalidRating_throwsIllegalValueException() {
        JsonAdaptedFoodplace foodplace =
                new JsonAdaptedFoodplace(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CUISINE,
                        VALID_TAGS, VALID_NOTE, INVALID_RATING, VALID_WISHLIST);
    ...
    public void toModelType_invalidCuisine_throwsIllegalValueException() {
        ...
        JsonAdaptedFoodplace adapted = new JsonAdaptedFoodplace("Alice", "91234567",
                "alice@example.com", "123, Jurong West Ave 6",
                "!!invalid!!", tags, "note", 5, VALID_WISHLIST);
    ...
    public void toModelType_nullWishlist_throwsIllegalValueException() {
        JsonAdaptedFoodplace foodplace =
                new JsonAdaptedFoodplace(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_CUISINE,
                        VALID_TAGS, VALID_NOTE, VALID_RATING, null);
