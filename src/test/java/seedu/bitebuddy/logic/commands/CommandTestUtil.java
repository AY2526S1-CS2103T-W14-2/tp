...
public class CommandTestUtil {
    ...
    public static final String VALID_OPEN_TIME_MCRONALDS = "08:00";
    public static final String VALID_CLOSE_TIME_MCRONALDS = "22:00";
    public static final String VALID_OPEN_TIME_SWENSWAN = "10:00";
    public static final String VALID_CLOSE_TIME_SWENSWAN = "23:00";
    ...
    public static final String OPEN_TIMING_DESC_MCRONALDS = " " + PREFIX_OPEN + VALID_OPEN_TIME_MCRONALDS;
    public static final String OPEN_TIMING_DESC_SWENSWAN = " " + PREFIX_OPEN + VALID_OPEN_TIME_SWENSWAN;
    public static final String CLOSE_TIMING_DESC_MCRONALDS = " " + PREFIX_CLOSE + VALID_CLOSE_TIME_MCRONALDS;
    public static final String CLOSE_TIMING_DESC_SWENSWAN = " " + PREFIX_CLOSE + VALID_CLOSE_TIME_SWENSWAN;
