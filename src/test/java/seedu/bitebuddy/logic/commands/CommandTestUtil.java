...
public class CommandTestUtil {
    ...
    public static final String VALID_RATE_AMY = "3";
    public static final String VALID_RATE_BOB = "8";
    ...
    public static final EditCommand.EditFoodplaceDescriptor DESC_AMY;
    public static final EditCommand.EditFoodplaceDescriptor DESC_BOB;

    static {
        DESC_AMY = new EditFoodplaceDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditFoodplaceDescriptorBuilder().withName(VALID_NAME_BOB)
