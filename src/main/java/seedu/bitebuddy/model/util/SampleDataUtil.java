    ...
    public static Foodplace[] getSampleFoodplaces() {
        return new Foodplace[] {
            new Foodplace(new Name("McRonalds"), new Phone("68765432"), new Email("info@mcronalds.com"),
                new Address("Blk 451, Clementi Ave 3 #01-309, S120451"), new Timing(LocalTime.parse("10:00"), LocalTime.parse("22:00")), new Cuisine("Western"),
            ...
            new Foodplace(new Name("SistersRamen"), new Phone("68765431"), new Email("info@sisramen.com"),
                new Address("10 Anson Rd, International Plaza, #01-20, S079903"), new Timing(LocalTime.parse("11:30"), LocalTime.parse("23:00")), new Cuisine("Japanese"),
            ...
            new Foodplace(new Name("Changibee"), new Phone("98765432"), new Email("support@changibee.com"),
                new Address("7 Pasir Ris Central, #B2-27, S519612"), new Timing(LocalTime.parse("09:00"), LocalTime.parse("21:00")), new Cuisine("Western"),
            ...
            new Foodplace(new Name("Fung Tai Din"), new Phone("87654321"), new Email("cs@fungdaitin.com"),
                new Address("23 Serangoon Central, #B1-10, S556083"), new Timing(LocalTime.parse("12:00"), LocalTime.parse("00:00")), new Cuisine("Chinese"),
            ...
            new Foodplace(new Name("Gucci Y Guaca"), new Phone("65655656"), new Email("go@gyg.com"),
                new Address("1 Tampines Walk, #01-99 Our Tampines Hub, S528523"), new Timing(LocalTime.parse("10:30"), LocalTime.parse("22:30")), new Cuisine("Mexican"),
            ...
            new Foodplace(new Name("Agent 47 Thai Food"), new Phone("98762345"), new Email("agent@47thai.com"),
                new Address("354 Clementi Ave 2, #01-235, S120354"), new Timing(LocalTime.parse("10:00"), LocalTime.parse("20:00")), new Cuisine("Thai"),
