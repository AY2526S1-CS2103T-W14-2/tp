...
public class LogsCenter {
    ...
    public static void init(Config config) {
        ...
        baseLogger.log(Level.INFO, "Log level will be set as: {0}", currentLogLevel);
    ...
    public static Logger getLogger(String name) {
        ...
        Logger newLogger = Logger.getLogger(baseLogger.getName() + "." + name);
        removeHandlers(newLogger);
    ...
    private static Logger setBaseLogger() {
        ...
        newBaseLogger.addHandler(consoleHandler);
        ...
        try {
            ...
            newBaseLogger.addHandler(fileHandler);
        } catch (IOException e) {
            newBaseLogger.warning("Error adding file handler for logger.");
        }
